...
import UploadImageProfile from "../../../components/UploadImage/UploadProfile/UploadProfile";
    ...
    return (
        <div>
            ...
            <div className={style.conteiner}>
                ...
                <div className={style.div}><UploadImageProfile/></div>
            </div>
            <br />
            <br />
            <div className={style.conteiner}>
            ...
            <div className={style.conteiner}>
                ...
                <div className={style.div}><input className={style.input} type="date" id="start" name="trip-start" value="2023-00-00"
            ...
            <div className={style.conteiner}>
                <div className={style.div}></div>
                <div className={style.div}></div>
                <div className={style.div}><button>Save</button></div>
                <div className={style.div}><button>{
                (userActual.proveedor === false) ? 
                'You want to be a Provider of Andromeda Games' : 'View Provider profile'
                }</button></div>
            </div>
        </div>
    );
